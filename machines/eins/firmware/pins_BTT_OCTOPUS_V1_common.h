...
// Machdyne PNP uses physical limit switches:
...
// Machdyne PNP limit switches

#define X_STOP_PIN								PG6
#define Y_STOP_PIN								PG9
...
// NOTE: X and Y have been swapped for Machdyne PNP:
